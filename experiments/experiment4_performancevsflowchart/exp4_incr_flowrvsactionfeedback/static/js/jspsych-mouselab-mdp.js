...
jsPsych.plugins['mouselab-mdp'] = (function() {
  ...
  MouselabMDP = class MouselabMDP {
    constructor(config) {
      var prs, blockName, centerMessage, leftMessage, lowerMessage, prompt, rightMessage, size, trial_id;
