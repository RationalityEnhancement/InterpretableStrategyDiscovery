from RL2DT.MCRL.agents import Agent
from RL2DT.MCRL.mouselab import MouselabEnv
from RL2DT.MCRL.distributions import Categorical, Normal
from RL2DT.MCRL.modified_mouselab_new import TrialSequence
from RL2DT.MCRL.policies import FunctionPolicy
from RL2DT.MCRL.exact import solve
from contexttimer import Timer
from frozendict import frozendict
from RL2DT.hyperparams import BRANCHING, STRATEGY, STRATEGY_NAME, ENV_TYPE, DISTRIBUTION
...
def get_modified_demonstrations(demo_numbers, env_branching, strategy, policy, 
    ...
    for i in demo_numbers:
        ...
        print('Demos: {}'.format(demonstrations))
...
def get_demos_and_stats(num_demos, env_branching, strategy, policy, q_func):
    ...
    test_clicks, test_envs, state_action_distr = [], [], {}
...
def save_demos_and_stats(num_demos, demonstrations, further_demonstrations, 
    ...
    """
    cwd = os.getcwd()
    folder_path = cwd + "/farsighted_strategy/"
