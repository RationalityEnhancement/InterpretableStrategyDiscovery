from RL2DT.MCRL.planning_strategies import strategy_dict
from RL2DT.MCRL.pure_planning_strategies import strategy_dict as strategy_dict_pure

## parameters defining the Mouselab environment
DISTRIBUTION = {1: [-4,-2,2,4],   
                2: [-8,-4,4,8],   
                3: [-48,-24,24,48],   
                4: [-48, -24, 24, 48], 
                5: [-48, -24, 24, 48]}
