...
def get_modified_demonstrations(demo_numbers, env_branching,
                                strategy, policy, q_func):
    """
...
if __name__ == "__main__":
    ...
    e = make_modified_env(BRANCHING)
    e2 = make_env(1, BRANCHING, DISTRIBUTION, ground_truth=e.ground_truth)
    strategy = STRATEGY
